...
class COCOInstanceAPI:
    def __init__(self, coco_dataroot: str) -> None:
        ...
        for split in ["train", "val"]:
            ...
            # print(f"Split: {split}, Instance Image Paths: {instance_img_fpaths}")
            ...
            # print("Starting to populate fname_to_instanceimgfpath_dict...")
            for instance_img_fpath in instance_img_fpaths:
                ...
                # print(f"Added key: {fname_stem} with path: {instance_img_fpath}")
    ...
    def get_instance_annotations(self, split: str) -> List[str]:
        ...
        """
        # print(f"self.annotations_root : {self.annotations_root}")
    ...
    def get_instance_id_img(self, split: str, fname_stem: str) -> np.ndarray:
        ...
        # print(self.fname_to_instanceimgfpath_dict)
