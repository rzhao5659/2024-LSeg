...
class COCOSemanticExtractor:
    def __init__(self, dataset_root:str) -> None:  # , coco_dataroot):
        """
        ...
        self.orig_dataroot = dataset_root#infos[self.orig_dname].dataroot
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_root", type=str, required=True, help="Root path of COCO dataset")
    args = parser.parse_args()

    print("Dumping COCO semantic labels into PNGs...")
    print(args)
    cse = COCOSemanticExtractor(dataset_root=args.dataset_root)  # coco_dataroot)
