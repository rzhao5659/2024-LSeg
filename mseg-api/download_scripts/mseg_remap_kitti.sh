...
# Remaps KITTI from 34-class task to 19-class task.

# Destination directory for KITTI
KITTI_DST_DIR=$1
NUM_CORES_TO_USE=$2
...
ORIG_DNAME="kitti-34"
REMAP_DNAME="kitti-19"

ORIG_DROOT=$KITTI_DST_DIR
...
python3 -u $REPO_ROOT/mseg/label_preparation/remap_dataset.py \
